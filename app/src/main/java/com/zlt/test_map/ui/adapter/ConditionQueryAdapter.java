 ...
 * 路况查询列表接口
 */
public class ConditionQueryAdapter extends BaseQuickAdapter<ConditionQueryBean.DataBean.ListBean,BaseViewHolder> {
    public ConditionQueryAdapter(int layoutResId, @Nullable List<ConditionQueryBean.DataBean.ListBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ConditionQueryBean.DataBean.ListBean item) {
